...
import com.medicalapp.donorua.utils.extensions.isRegistered
...
class MainActivity : AppCompatActivity() {
    ...
    private fun configureViewForNotRegistered() {
        if (App.instance.sharedPrefs.getUser().isRegistered()) {
            return
        }
        ...
        // show banner
//        with(banner) {
//            setLeftButton(R.string.later) {
//                dismiss()
//            }
//            setRightButton(R.string.OK) {
//                simpleNavigate(FirstOpenActivity::class.java)
//            }
//            show()
//        }
